...
FinalDF.to_csv("../data/output/all_Excel_FinalDF_matches_2018-19_032820.csv", header=True, index=False)
...
sub.to_csv('../data/output/final_diffs_all_2018-19_Final_032820.csv', header=True, index=False)